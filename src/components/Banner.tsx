...
export function Banner({
  ...
  return (
    <>
      <style type="text/css">
        {`
          .${prefix}easy-discountly-container {
            all: revert;
            display: flex;
      ...
      <div
        className={`${prefix}easy-discountly-container ${prefix}easy-discountly-override`}
      >
        <span
          className={`${prefix}easy-discountly-message ${prefix}easy-discountly-override`}
        ...
        {!canRemoveBranding && (
          <a
            className={`${prefix}easy-discountly-branding`}
            href={`${env.NEXT_PUBLIC_SERVER_URL}`}
          >
            Powered by Discountly
          </a>
        )}
      </div>
    </>
