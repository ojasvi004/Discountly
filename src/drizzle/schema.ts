...
export const ProductCustomizationTable = pgTable("product_customizations", {
  ...
  locationMessage: text("location_message")
    .notNull()
    .default(
      "Hi there! We see that you're from <b>{country}</b>. We offer Parity Purchasing Power support—use the code <b>“{coupon}”</b> to enjoy a <b>{discount}%</b> discount if you need it"
    ),
